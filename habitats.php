...
<div class="hero-scene text-center">
  ...
  <article>
    ...
    <section class="hidden_animal_image" id="hidden_animal_image">
      <div class="text-left d-flex justify-content-center m-4 p-3" >
             ...
             <p  class="w-50">Description : Lorem, ipsum dolor sit amet consectetur adipisicing elit. Itaque non facilis necessitatibus aperiam magnam aliquam, sed deserunt minima dicta sint sapiente. Qui aliquam assumenda minus totam eos repudiandae nihil architecto.</p>
      ...
      <div class="container-fluid row w-100 p-2" >
        <div class="row m-3">
          <div class="text-center col-sm-12 col-md-6 col-lg-6">
                ...
                <img src="../image/animal/giraffe-215901_1280.jpg" alt="" class="rounded w-75">
           ...
           <section class="hidden_animal_detail" id="hidden_animal_detail">
                  <div class="text-left d-flex justify-content-center animal_description p-2 m-2">
                    <div class="w-75 container-fluid row">
                     <div class="col-6 text-center p-2 "><p>Prénom</p></div>
                     <div class="col-6 text-center p-2 "><p>Race</p></div>
 ...
 </p> </div><div class="col-12 text-left d-flex justify-content-center p-2 m-2">
<p>avis veterinaire</p></div>
                    </div>
                   </div>
                </section>
         </div>
